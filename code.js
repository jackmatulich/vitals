            ...
            var canvas = document.getElementById("ecg");/*SPECIFIC*/ 
            var ctx = ecg.getContext("2d");/*SPECIFIC*/ 
            var w = ecg.width,/*GENERIC*/ 
            h = ecg.height,
            speed = 1,/*GENERIC*/ 
            scanBarWidth = 20,/*GENERIC*/ 
            i=0,/*GENERIC*/ 
            data = EcgData[0].split(','),/*SPECIFIC*/ 
            color='#00ff00';/*SPECIFIC*/ 
            var px = 0;/*GENERIC*/ 
            var opx = 0;/*GENERIC*/ 
            var py = h/2; /* should equal 50 if height 100px */ /*SPECIFIC*/ 
            var opy = py; /* should equal 50 if height 100px */ /*SPECIFIC*/ 
            ctx.strokeStyle = color;/*SPECI/*SPECIFIC*/ FIC*/ 
            ctx.lineWidth = 3;/*SPECIFIC*/ 
            ctx.setTransform(1,0,0,-1,0,h);/*SPECIFIC*/ 
